...
using System.Text;
using MiguLibrary.IO.Utilities;
...
namespace MiguLibrary.IO
{
    public class EndianBinaryWriter : BinaryWriter
    {
        ...
        {
            Write(value ? (byte)0x01 : (byte)0x00);
        }
        ...
        public override void Write(string value) => Write(value, StringBinaryFormat.FixedLength, value.Length);
        ...
        public void WriteAlignmentPadding( int alignment, byte paddingByte = 0x00 )
        {
        ...
        private void DoScheduledFileSizeWrites( bool excludeHeader = true )
        {
