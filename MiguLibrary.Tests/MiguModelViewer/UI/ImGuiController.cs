...
namespace MiguModelViewer.UI
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        {
            var io = ImGui.GetIO();
            io.Fonts.AddFontFromFileTTF(path, size, IntPtr.Zero, io.Fonts.GetGlyphRangesJapanese());
        }
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
            ...
            Console.WriteLine($"End of ImGUI setup: {GL.GetError()}");
        }
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            _shader.Use();
            _shader.Uniform("projection_matrix", false, ref mvp);
            _shader.Uniform("in_fontTexture", 0);
